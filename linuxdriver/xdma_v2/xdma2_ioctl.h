...
#ifndef _XDMA2_IOCALLS_POSIX_H_
#define _XDMA2_IOCALLS_POSIX_H_
...
#define XDMA2_ADDRMODE_MEMORY (0)
#define XDMA2_ADDRMODE_FIXED (1)
...
struct xdma2_ioc_base {
	unsigned int magic;
	unsigned int command;
};

struct xdma2_ioc_info {
	struct xdma2_ioc_base	base;
...
/* IOCTL codes */
#define XDMA2_IOCINFO		_IOWR(XDMA2_IOC_MAGIC, XDMA2_IOC_INFO, \
					struct xdma2_ioc_info)
#define XDMA2_IOCOFFLINE		_IO(XDMA2_IOC_MAGIC, XDMA2_IOC_OFFLINE)
#define XDMA2_IOCONLINE		_IO(XDMA2_IOC_MAGIC, XDMA2_IOC_ONLINE)

 /*Operation and structures definitions for XDMA2 engines*/
 
/*Structure for performance test 
(XDMA2_IOCTL_PERF_TEST ioctl operation)*/
struct xdma2_performance_ioctl {
...
/*Type (direction) of XDMA2 operation*/
enum xdma2_transfer_mode
{XDMA_H2C, XDMA_C2H };
/*Structure for submitting the transfer request
(XDMA2_IOCTL_SUBMIT_TRANSFER ioctl operation */
struct xdma2_transfer_request {
...
/*Direction of the transfer*/
	enum xdma2_transfer_mode mode;
};
/* IOCTL codes */
/*Do performance measurement test*/
#define XDMA2_IOCTL_PERF_TEST   _IOWR(XDMA2_IOC_MAGIC, 1, struct xdma2_performance_ioctl )
/*Switch between usual (incrementing) address mode [false] and 
fixed (non-incrementing) [true]*/
#define XDMA2_IOCTL_ADDRMODE_SET _IOW(XDMA2_IOC_MAGIC, 4, bool)
/*Retrieve currently set address mode*/
#define XDMA2_IOCTL_ADDRMODE_GET _IOR(XDMA2_IOC_MAGIC, 5, bool)
/*Return value of address alignment configuration*/
#define XDMA2_IOCTL_ALIGN_GET    _IOR(XDMA2_IOC_MAGIC, 6, int)
/*Transfer request operation*/
#define XDMA2_IOCTL_SUBMIT_TRANSFER   _IOWR(XDMA2_IOC_MAGIC, 7, struct xdma2_transfer_request )

#endif /* _XDMA2_IOCALLS_POSIX_H_ */
